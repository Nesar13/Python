...
#print (catenate(['scooby', 'knows', 'dancing']))
...
def catenateLoop(str_list):
    ...
    for x in str_list: 
        output=output+x
    return output
print (catenateLoop(['ammar', 'is', 'cool']))
...
#print (wordScore('nice', scrabbleScores))

def wordScoreLoop(S, scorelist):
    '''Same as wordScore'''
    score = 0
    for letter in range(len(S)):
        score += letterScoreLoop(S[letter],scorelist)
    return score

#print (wordScoreLoop('abc', scrabbleScores))
